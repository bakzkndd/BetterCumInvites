...
const { getModule, findByStrings } = cumcord.modules.webpack;
const Tooltip = getModule("TooltipContainer");
...
export default (data) => {
  return {
    ...
    async patchInvites() {
      const Invite = findByStrings("v=e.guild,y=e.invite");
      this.patched = after("", Invite.prototype, (args, res) => {
